 ...
 */
if ( file_exists( __DIR__ . '/wp-content/themes/iem/vendor/autoload.php' ) ) :
	require_once __DIR__ . '/wp-content/themes/iem/vendor/autoload.php';
	$dotenv = new Dotenv\Dotenv( __DIR__ );
	$dotenv->load();
endif;

if ( file_exists( dirname( __DIR__ ) . '/wp-content/themes/iem/vendor/autoload.php' ) ) :
	require_once dirname( __DIR__ ) . '/wp-content/themes/iem/vendor/autoload.php';
